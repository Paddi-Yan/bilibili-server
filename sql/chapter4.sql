...
CREATE TABLE `t_danmu`  (
  ...
  `danmaku_time` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '弹幕出现时间',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `t_video_coin`  (
  ...
  `user_id` bigint NULL DEFAULT NULL COMMENT '用户id',
  `video_id` bigint NULL DEFAULT NULL COMMENT '视频投稿id',
...
CREATE TABLE `t_video_collection`  (
  ...
  `video_id` bigint NULL DEFAULT NULL COMMENT '视频投稿id',
  `user_id` bigint NULL DEFAULT NULL COMMENT '用户id',
  `group_id` bigint NULL DEFAULT NULL COMMENT '收藏分组id',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `t_video_comment`  (
  ...
  `replyuser_id` bigint NULL DEFAULT NULL COMMENT '回复用户id',
  `root_id` bigint NULL DEFAULT NULL COMMENT '根节点评论id',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
